								...
								<section>
									...
									<?php
										if($_POST['temp'] =='추움'){
											...
											mysqli_query($con, "delete from a where temp>=15");
											mysqli_close($con);
										}
										else if($_POST['temp'] =='서늘'){
											
											mysqli_query($con, "delete from a where temp<=15 and temp>=20");
											mysqli_close($con);
										}
										else{
										
											mysqli_query($con, "delete from a where temp<20");
											mysqli_close($con);
										}
									?>

									<form method="post" action= "find_plants_4.php" name="selectSize">
											<p style="font-size:2.5em;"><strong> Q3. 어떤 키의 식물을 원하시나요? </strong></p> <br>
									
                                            <div>
                                             <input type="radio" name="size" id="size1" value="미니"> 
                                                <label for="size1" style="font-size:25px;"> 미니 식물(20cm 이하) </label> </input><br><br>

                                              
                                             <input type="radio" name="size" id="size2" value="작은">
                                                <label for="size2" style="font-size:25px;"> 보통 식물(20~50cm) </label> </input> <br><br>
                                             <input type="radio" name="size" id="size3" value="적당"> 
                                                 <label for="size3" style="font-size:25px;"> 키가 큰 식물 (50cm 이상) </label> </input><br><br>
