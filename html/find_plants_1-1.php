					...
					<div id="main">
						<div class="inner">
							...
							<header id="header">
								...
								<form method="post" action= "find_plants_2.php" name="selectAbility">
									<p style="font-size:2.5em;"><strong>Q1-1. 결과가 어떠셨나요? </strong></p> <br>
									
                                <div>
                                     <input type="radio" name="ability"  id="abil1" value="하" style="width:50px;height:50px;"> 
                                        <label for="abil1" style="font-size:25px;"> 저는 식물 킬러입니다. </label> </input>
                                    <br><br>
                                   
                                     <input type="radio" name="ability"  id="abil2" value="중" style="width:50px;height:50px;"> 
                                        <label for="abil2" style="font-size:25px;"> 보통입니다. </label> </input>
                                    <br><br>
                                   
                                     <input type="radio" name="ability"  id="abil3" value="상" style="width:50px;height:50px;"> 
                                        <label for="abil3" style="font-size:25px;"> 전문가 수준입니다. </label> </input>
                                    <br><br>    
