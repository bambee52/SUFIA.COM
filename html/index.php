            ...
            <div id="main">
                <div class="inner">
                    ...
                    <section id="banner">
                        <div class="content">
                            <header>
                                <!-- <h1>수피아 닷컴에 오신 것을 환영합니다!!<br/> -->
                            </h1>
                            <p>수피아닷컴에 오신 것을 환영합니다!
                            </p>
                        </header>
                        ...
                        <div style="width:100%; text-align:center;">
                            <!-- <button
                                type="button"
                                onclick="location.href = 'find_plants_1.php' "
...
<!-- 
                            ...
                            <input type="image" src="button.gif" onclick="location.href = 'find_plants_1.php'">
