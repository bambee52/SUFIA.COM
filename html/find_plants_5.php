								...
								<section>
									...
									<?php
										if($_POST['color'] =='하나'){
											...
											mysqli_query($con, "delete from a where color>1");
											mysqli_close($con);
										}
										else{
									...
									<form method="post" action= "result_plants.php" name="selectPrice">
											<p style="font-size:2.5em;"><strong> Q5. 원하는 가격대가 있으신가요? </strong></p> <br>
										
                                            <div>
                                             <input type="radio" name="price" id="price1" value="상관무"> 
                                                <label for="price1" style="font-size:25px;">상관없어요. </label> </input><br><br>

                                               
                                             <input type="radio" name="price" id="price2" value="저렴"> 
                                                <label for="price2" style="font-size:25px;">저렴한 가격을 원해요.</label> </input><br><br>
