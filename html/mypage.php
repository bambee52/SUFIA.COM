        ...
        <div id="wrapper">
            ...
            <div id="main">
                ...
                while($member = $sql->fetch_array()){
                    ?>
                                ...
                                <div>
                                    <button type="button" onclick="location.href='mypage_modify.php'">회원 정보 수정</button>
                                </div>
            ...
            ?>
                              ...
                              <h1>내가 찜한 식물<br/>
                                ...
                                <?php
                                  $result = mysqli_query($con, "select title, img from user_like");
                                  ...
                                  /*    $like= '<form action="like_ok.php" method="POST">
                                              ...
                                              <input type="image" src="heart.png" width=30 height=30>
