								...
								<section>
									...
									<?php
										if($_POST['size'] =='미니'){
											...
											mysqli_query($con, "delete from a where height>20");
											mysqli_close($con);
										}
										else if($_POST['size'] =='작은'){
											
											mysqli_query($con, "delete from a where height<=20 and height>50");
											mysqli_close($con);
										}
										else{
											
											mysqli_query($con, "delete from a where height<50");
											mysqli_close($con);
										}
									?>

									<form method="post" action= "find_plants_5.php" name="selectColor">
											<p style="font-size:2.5em;"><strong>Q4. 어떤 색감의 식물을 좋아하세요?</strong></p> <br>
                                            
                                            <div>
                                             <input type="radio" name="color" id="color1" value="하나">
                                                <label for="color1" style="font-size:25px;"> 단일 색 </label> </input><br><br>
                                                
                                             <input type="radio" name="color" id="color2" value="둘"> 
                                                  <label for="color2" style="font-size:25px;"> 두 가지 이상의 색 </label> </input><br><br>
