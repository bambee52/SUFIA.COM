...
<html>
    <head>
        ...
        <script language="javascript">
            function check() {
                var form = document.selectExperience;
                if (form.experience[0].checked == true) { // 1번째 라디오 버튼을 선택한 경우
                    // 현재 폼의 action 값을 find_plants_2.php라는 파일로 만든다.
                    form.action = "find_plants_1-1.php";
                } else if (form.experience[1].checked == true) { // 2번째 라디오 버튼을 선택한 경우
                    form.action = "find_plants_2.php";
                }
                ...
                <div class="inner">
                    ...
                    <section>
                        <header class="main">
                            ...
                            <form name="selectExperience" method="post" action= "find_plants_1-1.php">
                                ...
                                <p style="font-size:2.5em;">
                                    ...
                                    <!-- <h2> -->
                                        ...
                                        <div>
                                        <input type="radio" name="experience" id="exp1" value="예" style="width:50px;height:50px;">
                                            <label for="exp1" style="font-size:25px;"> 예. </label>
										</input>
										
                                    <br><br>
                                   
                                        <input type="radio" name="experience" id="exp2" value="아니오" style="width:50px;height:50px;">
                                        <label for="exp2" style="font-size:25px;"> 아니요, 처음입니다. </label>
                                        </input>
